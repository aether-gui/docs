...
Aether Ops tracks the installation state of every deployable component. This state tells you at a glance which components are installed, which are in progress, and which have failed -- without needing to inspect Kubernetes or Ansible directly.
