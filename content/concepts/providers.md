...
Providers are the modular building blocks of the Aether Ops API. Each provider owns a set of related endpoints under a dedicated URL path prefix, and each focuses on a single domain of functionality.
...
Aether Ops ships with five providers:
