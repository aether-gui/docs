...
```bash
aether-ops --onramp-version v2.1.0
```
...
# Pin to a branch
aether-ops --onramp-version main

# Pin to a specific commit
aether-ops --onramp-version abc123def456
```
...
By default, the OnRamp repository is cloned to a directory managed by aether-ops. Override this with:

```bash
aether-ops --onramp-dir /opt/aether-onramp
```
...
1. Start aether-ops with the desired `--onramp-version` (auto-clones on startup).
