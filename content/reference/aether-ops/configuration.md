...
The default OnRamp directory is `{data-dir}/aether-onramp` (typically `/var/lib/aether-ops/aether-onramp`). This can be overridden with the `--onramp-dir` [CLI flag](./cli.md).
